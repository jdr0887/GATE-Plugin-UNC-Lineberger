...
import org.renci.jlrm.sge.ssh.SGESubmitScriptExporter;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class LinebergerSubmitCondorGlideinCallable implements Callable<SGESSHJob> {

    private final Logger logger = LoggerFactory.getLogger(LinebergerSubmitCondorGlideinCallable.class);
    ...
    public LinebergerSubmitCondorGlideinCallable() {
        super();
    }

    public LinebergerSubmitCondorGlideinCallable(Site site, Queue queue, File submitDir, String jobName,
